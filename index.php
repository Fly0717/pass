			...
			<div class="container">
				...
				<div>
					<form action="" method="post" class="form">
						<div class="form-row">
							<input type="text" class="form-text" type="username" autocomplete="username" name="username"
								id="username" placeholder="用户名" required=""
								onkeyup="this.value=this.value.replace(/[^\w_]/g,'');">
						</div>
						<div class="form-row">
							<input type="password" class="form-text" type="password" name="password"
								autocomplete="current-password" id="password" placeholder="密码" required="">
						</div>
						<?php
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (!$username) {
                                    ...
                                    // 查询数据
                                    $sql = "SELECT * FROM user WHERE username='$username' AND md5passwd = '$md5Pwd'";
                                    $result = $conn->query($sql);
                                    if ($result->num_rows > 0) {
                                        echo "<script>window.location.href='loggedin.php?username=$username&password=$md5Pwd';</script>";
                                    } else {
                                        echo "账户或密码错误！";
                                    }
                                    // 关闭连接
						...
						<div class="form-row button-login">
							<input type="submit" value="登录" id="login" class="btn btn-login" />
						</div>
					</form>
				</div>
				<div style="margin-top: 50px;"></div>
				<p class="foot">
				    <a id="new-account" href="./userreg.php">注册账号</a> | <a href="./init.php">初始化数据库</a>
				    <?php 
