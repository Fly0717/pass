	...
	<div class="main" style="background: url(./assets/bg.jpg) no-repeat bottom;">
		<div class="main-container">
			<div class="container">
                                ...
                                if ($have == true) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        if ($username == $row["username"]) {
                                            ...
                                            echo "<tr style=\"color: red; font-weight: bold;\"><td>".$row["uid"]."</td><td>".$row["username"]."</td><td>".$row["md5passwd"]."</td></tr>";
                                        }
                                        else {
                                            echo "<tr><td>".$row["uid"]."</td><td>".$row["username"]."</td><td>".$row["md5passwd"]."</td></tr>";
                                        }
                                    }
                                } else {
                                    echo "<script>window.location.href='index.php';</script>";
				...
				<p class="foot">
				    <a id="already-account" href="./index.php">退出登录</a>
				    <?php 
                        echo "<br><br><span style=\"font-size: 14px; color: gray;\">本次为您服务的服务器IP：$ip<br>您的IP：$remote_ip<br>鼎力支持：爱你们的孙老师、网络工程2020级 谢宜轩</span>";
				    ?>
				</p>
			</div>
		</div>
